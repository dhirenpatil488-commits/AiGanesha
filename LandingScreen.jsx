    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="w-full max-w-5xl mx-auto px-5 md:px-10 py-16 md:py-24 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance leading-tight">
              Calculate Your
      ...
      <section className="w-full max-w-7xl mx-auto px-5 md:px-10 pb-16 md:pb-24">
        <div className="text-center mb-10">
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3">Choose Your Calculator</h3>
          ...
          {calculatorOptions.map((option) => (
            ...
            >
              <CardHeader className="pb-6">
                ...
                <CardTitle className="text-2xl sm:text-3xl text-foreground break-words text-balance">{option.title}</CardTitle>
                <CardDescription className="text-base sm:text-lg leading-relaxed text-muted-foreground mt-2 break-words text-balance">{option.description}</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <Button
                  className="w-full text-sm sm:text-base md:text-base py-3 sm:py-6 md:py-6 h-auto whitespace-normal rounded-xl hover:bg-primary transition-colors cursor-pointer flex-wrap justify-center"
                  variant="secondary"
