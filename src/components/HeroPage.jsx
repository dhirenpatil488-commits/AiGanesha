  ...
  return (
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <header className="border-b border-border/50 bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <div>
              <span className="font-bold text-lg text-foreground tracking-tight">ai<span style={{ color: "#F4A261" }}>G</span>anesha</span>
      ...
      <section className="relative flex-1 overflow-hidden">
        ...
        <div className="container mx-auto px-6 pt-8 pb-20 md:pt-12 md:pb-32 relative">
          <div className="max-w-3xl mx-auto text-center">

            {/* Platform name */}
            <p className="text-accent font-semibold text-sm uppercase tracking-widest mb-4">ai<span style={{ color: "#F4A261" }}>G</span>anesha</p>

            {/* Headline */}
            <h1 className="text-3xl sm:text-5xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight tracking-tight text-balance break-words">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
              ai<span style={{ color: "#F4A261" }}>G</span>anesha provides accessible tools to understand and measure greenhouse gas emissions
            ...
            <Button
              ...
              variant="secondary"
              size="lg"
              className="text-sm sm:text-base px-5 py-4 sm:px-8 sm:py-6 rounded-xl font-semibold shadow-lg shadow-secondary/30 hover:bg-primary hover:shadow-primary/30 transition-all duration-300"
            >
