            ...
            <main className="glass-panel" style={{ padding: '2rem' }}>
                {!isResults ? (
                            ...
                            {activeStepData.id === 'household' && (
                                <>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="radio-group" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '0.5rem' }}>
                                ...
                                <>
                                    <div className="form-group">
                                        ...
                                        <div className="range-wrap">
                                            ...
                                            <input type="number" name="electricityBillPerMonth" className="number-input" value={formData.electricityBillPerMonth} onChange={handleInput} style={{ width: '100px' }} />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                    ...
                                    {formData.hasSolar && (
                                        <div className="form-group" style={{ paddingLeft: '1.5rem', borderLeft: '2px solid var(--accent-primary)' }}>
                                            ...
                                            <select name="solarPercentage" value={formData.solarPercentage} onChange={handleInput} style={{ padding: '0.75rem', background: 'rgba(0,0,0,0.2)', color: 'var(--text-primary)', border: '1px solid var(--card-border)', borderRadius: '8px', outline: 'none', marginTop: '0.5rem', width: '100%', fontFamily: 'inherit' }}>
                            ...
                            {activeStepData.id === 'cooking' && (
                                <>
                                    <div className="form-group">
                                        ...
                                        <select name="cookingFuel" value={formData.cookingFuel} onChange={handleInput} style={{ padding: '0.75rem', background: 'rgba(0,0,0,0.2)', color: 'var(--text-primary)', border: '1px solid var(--card-border)', borderRadius: '8px', outline: 'none', marginTop: '0.5rem', width: '100%', fontFamily: 'inherit' }}>
                                    ...
                                    {(formData.cookingFuel === 'png' || formData.cookingFuel === 'mixed') && (
                                        <div className="form-group">
                                            ...
                                            <div className="range-wrap">
                                                ...
                                                <input type="number" name="pngBillPerMonth" className="number-input" value={formData.pngBillPerMonth} onChange={handleInput} style={{ width: '100px' }} />
                                            </div>
                                        </div>
                                    )}
                                </>
                            ...
                            {activeStepData.id === 'transport' && (
                                <>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <button onClick={addVehicle} style={{ padding: '0.5rem 1rem', background: 'rgba(255,255,255,0.1)', color: 'var(--text-primary)', border: '1px solid var(--card-border)', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                            <Plus size={14} /> Add Vehicle
                                        </button>
                                    </div>

                                    {formData.vehicles.length === 0 ? (
                                        <div style={{ padding: '2rem', textAlign: 'center', background: 'rgba(0,0,0,0.2)', borderRadius: '8px', border: '1px dashed var(--card-border)', color: 'var(--text-secondary)' }}>
                                            No personal vehicles. Generating zero transport emissions.
                                        </div>
                                    ) : (
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                            {formData.vehicles.map((v, index) => (
                                                <div key={v.id} style={{ padding: '1.5rem', background: 'rgba(255,255,255,0.03)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', position: 'relative' }}>
                                                    ...
                                                    <div style={{ marginBottom: '1rem', fontWeight: '500', color: 'var(--accent-primary)' }}>Vehicle {index + 1}</div>
                                                    
                                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1rem' }}>
                                                        <select value={v.type} onChange={(e) => updateVehicle(v.id, 'type', e.target.value)} style={{ padding: '0.75rem', background: 'rgba(0,0,0,0.4)', color: 'var(--text-primary)', border: '1px solid var(--card-border)', borderRadius: '6px', outline: 'none', width: '100%' }}>
                            ...
                            {activeStepData.id === 'food' && (
                                <>
                                    <div className="form-group">
                                        ...
                                        <select name="dietType" value={formData.dietType} onChange={handleInput} style={{ padding: '0.75rem', background: 'rgba(0,0,0,0.2)', color: 'var(--text-primary)', border: '1px solid var(--card-border)', borderRadius: '8px', outline: 'none', width: '100%', marginTop: '0.5rem', fontFamily: 'inherit' }}>
                                ...
                                <>
                                    <div className="form-group">
                                        ...
                                        <div className="range-wrap">
                                            ...
                                            <input type="number" name="shoppingSpendPerMonth" className="number-input" value={formData.shoppingSpendPerMonth} onChange={handleInput} style={{ width: '100px' }} />
                                        </div>
                            ...
                            {activeStepData.id === 'waste' && (
                                <>
                                    <div className="form-group">
                                        ...
                                        <div className="radio-group" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '0.5rem' }}>
                                            {[
                                    ...
                                    <div className="form-group" style={{ gap: '1rem', marginTop: '1rem' }}>
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer', padding: '1rem', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--card-border)', borderRadius: '8px' }}>
                            ...
                            {activeStepData.id === 'lifestyle' && (
                                <>
                                    <div className="form-group" style={{ gap: '1rem' }}>
                                        <label style={{ display: 'flex', justifyItems: 'center', gap: '0.75rem', cursor: 'pointer', padding: '1rem', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--card-border)', borderRadius: '8px' }}>
                    ...
                    <div className="results-dashboard" style={{ animation: 'fadeInDown 0.8s ease-out' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                                    <span style={{ fontSize: '4.5rem', fontWeight: '800', lineHeight: 1, color: getIntensityColor(emissions.annualTonnes.perCapita) }}>
                                        {emissions.annualTonnes.perCapita.toFixed(2)}
                                    </span>
                                    <span style={{ fontSize: '1.5rem', color: 'var(--text-secondary)', fontWeight: '500' }}>t CO₂e / year</span>
                                </div>
                        ...
                        <div className="results-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                            {/* Left Column */}
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                {/* Comparison Bar */}
                                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--card-border)' }}>
                                    <h3 style={{ fontSize: '1rem', marginBottom: '1.5rem', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Globe size={18}/> Global Comparison</h3>
                                ...
                                {/* Context Block */}
                                <div style={{ background: 'rgba(88, 166, 255, 0.05)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(88, 166, 255, 0.2)' }}>
                                    <h3 style={{ fontSize: '1rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>This is equivalent to:</h3>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                ...
                                <div style={{ background: 'rgba(0,0,0,0.2)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--card-border)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    <h3 style={{ fontSize: '1rem', color: 'var(--text-primary)', width: '100%', textAlign: 'left', marginBottom: '1rem' }}>Impact Breakdown</h3>
                                ...
                                {/* Actions */}
                                <div style={{ background: 'linear-gradient(135deg, rgba(63, 185, 80, 0.1) 0%, transparent 100%)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(63, 185, 80, 0.2)' }}>
                                    <h3 style={{ fontSize: '1rem', marginBottom: '1rem', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Lightbulb size={18} color="var(--success)"/> How you can reduce emissions</h3>
                                    <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'var(--text-primary)', fontSize: '0.9rem' }}>
                                        {emissions.percentages.energy > 15 && (
                                            <li style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
                        ...
                        {/* Share Block */}
                        <div style={{ marginTop: '2rem', padding: '1.5rem', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid var(--card-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                            <div>
                            ...
                            <button style={{ padding: '0.75rem 1.5rem', background: 'var(--bg-color)', border: '1px solid var(--card-border)', color: 'var(--text-primary)', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', transition: 'all 0.2s' }}>
