                ...
                <div className="w-full max-w-[680px] mx-auto px-4 sm:px-0 grid grid-cols-2">
                    <div className="py-4 sm:py-6 flex items-center">
                        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                            ...
                            <span className="font-bold text-[15px] sm:text-base text-foreground tracking-tight">AiGanesha</span>
                        </div>
                    </div>
                    <div className="py-4 sm:py-6 flex items-center justify-end">
                        <a href="mailto:founder@aiganesha.org" className="text-[13px] sm:text-[14px] font-mono text-muted-foreground hover:text-foreground transition-colors uppercase tracking-widest">
                            Contact
                        </a>
                    </div>
                </div>
            ...
            <section className="relative overflow-hidden border-b border-dotted border-white/15">
                <div className="w-full max-w-[680px] mx-auto px-4 sm:px-0">
                    <div className="py-10 sm:py-20 space-y-8 sm:space-y-10">
                        ...
                        <h1 className="text-[32px] sm:text-[40px] leading-[1.2] tracking-[-0.03em] font-bold text-foreground text-balance">
            ...
            <section className="border-b border-dotted border-white/15">
                <div className="w-full max-w-[680px] mx-auto px-4 sm:px-0">
                    ...
                    <div className="py-8 sm:py-10 border-b border-dotted border-white/15">
                        <h2 className="text-[24px] sm:text-[26px] leading-[1.4] tracking-[-0.03em] font-bold text-foreground mb-4">Climate Reality</h2>
                    ...
                    {/* Our Vision */}
                    <div className="py-8 sm:py-10 border-b border-dotted border-white/15">
                        <h2 className="text-[24px] sm:text-[26px] leading-[1.4] tracking-[-0.03em] font-bold text-foreground mb-4">Our Vision</h2>
                        <p className="text-[15px] sm:text-[16px] leading-[1.48] tracking-[-0.02em] text-muted-foreground">
                    ...
                    <div className="py-8 sm:py-10">
                        <h2 className="text-[24px] sm:text-[26px] leading-[1.4] tracking-[-0.03em] font-bold text-foreground mb-4">Our Mission</h2>
                        <p className="text-[15px] sm:text-[16px] leading-[1.48] tracking-[-0.02em] text-muted-foreground">
