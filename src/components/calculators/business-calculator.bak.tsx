  ...
  return (
    <div className="w-full flex flex-col relative z-10 font-mono">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-10">
        <div className="max-w-[600px] w-full px-4 sm:px-0 mx-auto">
          {/* Step 1: Business Type */}
          {currentStep === 1 && (
            <Card className="bg-card border-border shadow-lg">
              <CardHeader className="pb-8">
                <CardTitle className="flex items-center gap-3 text-2xl sm:text-3xl tracking-tight leading-tight font-bold font-mono">
                ...
                <Select value={data.businessType} onValueChange={(v) => updateData("businessType", v as BusinessData["businessType"])}>
                  ...
                  <SelectContent>
                    {BUSINESS_TYPES.map((type) => (
                      <SelectItem key={type.id} value={type.id} className="font-mono text-sm sm:text-base py-2 sm:py-3">
                        {type.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-6">
                    <Slider
                      ...
                      className="flex-1"
                    />
                    <span className="text-xl sm:text-3xl font-bold font-mono text-primary w-12 sm:w-16 text-center">{data.employees}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <>
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="diesel" className="font-mono text-sm sm:text-base py-2 sm:py-3">Diesel</SelectItem>
                          <SelectItem value="petrol" className="font-mono text-sm sm:text-base py-2 sm:py-3">Petrol</SelectItem>
                          <SelectItem value="cng" className="font-mono text-sm sm:text-base py-2 sm:py-3">CNG</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div className="space-y-4">
                    ...
                    {t === "restaurant" && (
                      <div className="space-y-4">
                        ...
                        <Select value={data.compostsWaste} onValueChange={(v) => updateData("compostsWaste", v as BusinessData["compostsWaste"])}>
                          ...
                          <SelectContent>
                            <SelectItem value="yes" className="font-mono text-sm sm:text-base py-2 sm:py-3">Yes, we compost</SelectItem>
                            <SelectItem value="no" className="font-mono text-sm sm:text-base py-2 sm:py-3">No</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    )}
          ...
          <div className="flex items-center justify-between mt-8 sm:mt-12 mb-10 sm:mb-20">
            <Button variant="outline" size="lg" onClick={handlePrev} disabled={currentStep === 1} className="gap-2 text-xs sm:text-sm h-12 px-6 sm:h-14 sm:px-8 font-mono uppercase tracking-widest">
              <ChevronLeft className="h-4 w-4 sm:h-5 sm:w-5" />
              Previous
            </Button>
            <Button size="lg" onClick={handleNext} className="gap-2 text-xs sm:text-sm h-12 px-6 sm:h-14 sm:px-8 font-mono uppercase tracking-widest">
